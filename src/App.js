        ...
        <Routes>
          <Route path={path.PUBLIC} element={<Public />}>
            ...
            <Route path ={path.SEARCH} element ={<Search/>}>
              <Route path ={path.SEARCHSONGALL} element={<SearchSongAll/>}></Route>
              <Route path ={path.SEARCHSONG} element={<SearchSongs/>}> </Route>
              <Route path ={path.SEARCH_PLAYLIST_ALBUM} element={<SearchPlaylistAlbum/>}> </Route>
              <Route path ={path.SEARCH_ARTIST} element={<SearchArtists/>}> </Route>
            </Route>
